...
mkdir /opt/wireguard-ui
    ...
    wget https://raw.githubusercontent.com/MajorTomDE/wireguard_pve/main/wireguard/wgui.path -O /etc/systemd/system/wgui.path
    wget https://raw.githubusercontent.com/MajorTomDE/wireguard_pve/main/wireguard/wgui.service -O /etc/systemd/system/wgui.service
    wget https://raw.githubusercontent.com/MajorTomDE/wireguard_pve/main/wireguard/wireguard-ui.service -O /etc/systemd/system/wireguard-ui.service
